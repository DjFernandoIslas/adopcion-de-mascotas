...
def login():
    ...
    if request.method == 'POST' and 'txtCorreo' in request.form and 'txtPassword' in request.form:
        ...
        if account:
            ...
            return render_template('index.html',mensaje="Inicio de sesion exitoso!")
...
def crear_registro(): 
    if request.method == 'POST':    
        ...
        cur = mysql.connection.cursor()
        cur.execute(" INSERT INTO usuarios (correo, password, nombre) VALUES (%s, %s, %s)",(correo,password,nombre))
